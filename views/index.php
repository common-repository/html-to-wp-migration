<div class="wrap no-js">
    <h2>CMSMove: <?php echo $source_cart; ?> to WordPress Migration</h2>
    <div class="content">
        <div class="litextension">
            <div id = "messages"></div>
            <div class="litextension_topdesc">
                <a class="litextension_logo" href="<?php echo $product_link; ?>" target="_blank">
                    <img  alt="Website Migration Made Easy" title="Website Migration Made Easy" src="<?php echo $img_url; ?>">
                </a>
                <div class="litextension_text">
                    <div class="lit-title"><?php echo $source_cart ?> to WordPress Migration</div>
                    It allows you to migrate all your blogs, posts, users, comments and other data from <?php echo $source_cart; ?> to WordPress within 3 simple steps.
            ...
            <div class="tabs_content">
                ...
                <form action="http://cmsmove.com/zendesk/lite/save" method="post" enctype="multipart/form-data" id="form">
            ...
            <span class="litextension_support"><span class="litextension_support_icon">If you have any question, please don't hesitate to <a href="http://cmsmove.com/contacts/" target="_blank">Contact Us</a>. We look forward to assisting you.</span></span>
        </div>
    </div>
</div>
